...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Athens : <span class="label label-primary">22198</span>
			...
			<p>	<span itemprop="about">Average household size in Athens : <span class="label label-primary">2.48</span>
			<p>	<span itemprop="about">Average family size in Athens : <span class="label label-primary">2.98</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Athens : <span class="label label-primary">64746</span>					
			</p>
