...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Boone : <span class="label label-primary">10560</span>
			...
			<p>	<span itemprop="about">Average household size in Boone : <span class="label label-primary">2.4</span>
			<p>	<span itemprop="about">Average family size in Boone : <span class="label label-primary">3.02</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Boone : <span class="label label-primary">26305</span>					
			</p>
