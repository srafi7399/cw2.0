...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Jackson : <span class="label label-primary">60391</span>
			...
			<p>	<span itemprop="about">Average household size in Jackson : <span class="label label-primary">2.5</span>
			<p>	<span itemprop="about">Average family size in Jackson : <span class="label label-primary">3.06</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Jackson : <span class="label label-primary">160122</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Jackson : <span class="label label-primary">150894</span>					
			</p>
