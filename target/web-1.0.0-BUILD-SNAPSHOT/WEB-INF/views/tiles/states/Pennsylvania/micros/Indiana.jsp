...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Indiana : <span class="label label-primary">34162</span>
			...
			<p>	<span itemprop="about">Average household size in Indiana : <span class="label label-primary">2.41</span>
			<p>	<span itemprop="about">Average family size in Indiana : <span class="label label-primary">2.97</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Indiana : <span class="label label-primary">88128</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Indiana : <span class="label label-primary">83890</span>					
			</p>
