...
<div class="content-wrapper">
	...
	<div class="row">      
          <ol class="breadcrumb">
            ...
            <li class="active">cities-Puerto-Rico</li>
          </ol>
 </div>
	</section>
...
<div class="table-responsive">
  <table class="table table-condensed table-striped table-bordered table-hover no-margin">
    ...
    <tbody>    
      ...
      <tr>       
        <td>        
          <span class="name"> <a href="/states/Puerto-Rico/cities/Arecibo-zona-urbana">Arecibo zona urbana</a></span>
        </td>        
        <td>44677     
        </td>
        <td>46.8% Male and 53.2% female
      ...
      <tr>       
        <td>        
          <span class="name"> <a href="/states/Puerto-Rico/cities/Ponce-zona-urbana">Ponce zona urbana</a></span>
        </td>        
        <td>129402     
        </td>
      ...
      <tr>       
        <td>        
          <span class="name"> <a href="/states/Puerto-Rico/cities/Caguas-zona-urbana">Caguas zona urbana</a></span>
        </td>        
        <td>82974     
        </td>
      ...
      <tr>       
        <td>        
          <span class="name"> <a href="/states/Puerto-Rico/cities/Mayaguez-zona-urbana">Mayaguez zona urbana</a></span>
        </td>        
        <td>68787     
        </td>
      ...
      <tr>       
        <td>        
          <span class="name"> <a href="/states/Puerto-Rico/cities/Guayama-zona-urbana">Guayama zona urbana</a></span>
        </td>        
        <td>23575     
        </td>
