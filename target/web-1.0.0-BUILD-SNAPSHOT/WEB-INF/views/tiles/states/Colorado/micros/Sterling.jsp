...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Sterling : <span class="label label-primary">7922</span>
			...
			<p>	<span itemprop="about">Average household size in Sterling : <span class="label label-primary">2.7</span>
			<p>	<span itemprop="about">Average family size in Sterling : <span class="label label-primary">3.46</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Sterling : <span class="label label-primary">22597</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Sterling : <span class="label label-primary">N</span>					
			</p>
