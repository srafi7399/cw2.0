...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Knox County : <span class="label label-primary">22399</span>
			...
			<p>	<span itemprop="about">Average household size in Knox County : <span class="label label-primary">2.56</span>
			<p>	<span itemprop="about">Average family size in Knox County : <span class="label label-primary">3.05</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Knox County : <span class="label label-primary">60967</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Knox County : <span class="label label-primary">N</span>					
			</p>
