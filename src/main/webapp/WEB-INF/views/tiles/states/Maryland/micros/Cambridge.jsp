...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Cambridge : <span class="label label-primary">13333</span>
			...
			<p>	<span itemprop="about">Average household size in Cambridge : <span class="label label-primary">2.4</span>
			<p>	<span itemprop="about">Average family size in Cambridge : <span class="label label-primary">2.85</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Cambridge : <span class="label label-primary">32645</span>					
			</p>
