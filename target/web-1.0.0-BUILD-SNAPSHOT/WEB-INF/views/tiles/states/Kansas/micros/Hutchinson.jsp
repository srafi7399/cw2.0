...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Hutchinson : <span class="label label-primary">25402</span>
			...
			<p>	<span itemprop="about">Average household size in Hutchinson : <span class="label label-primary">2.42</span>
			<p>	<span itemprop="about">Average family size in Hutchinson : <span class="label label-primary">3.01</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Hutchinson : <span class="label label-primary">64278</span>					
			</p>
