...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Auburn : <span class="label label-primary">15986</span>
			...
			<p>	<span itemprop="about">Average household size in Auburn : <span class="label label-primary">2.62</span>
			<p>	<span itemprop="about">Average family size in Auburn : <span class="label label-primary">3.14</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Auburn : <span class="label label-primary">42318</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Auburn : <span class="label label-primary">N</span>					
			</p>
