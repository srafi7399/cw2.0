...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Mount Vernon : <span class="label label-primary">15032</span>
			...
			<p>	<span itemprop="about">Average household size in Mount Vernon : <span class="label label-primary">2.45</span>
			<p>	<span itemprop="about">Average family size in Mount Vernon : <span class="label label-primary">3.03</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Mount Vernon : <span class="label label-primary">38693</span>					
			</p>
