...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Washington : <span class="label label-primary">18667</span>
			...
			<p>	<span itemprop="about">Average household size in Washington : <span class="label label-primary">2.52</span>
			<p>	<span itemprop="about">Average family size in Washington : <span class="label label-primary">3.2</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Washington : <span class="label label-primary">47537</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Washington : <span class="label label-primary">N</span>					
			</p>
