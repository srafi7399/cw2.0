...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Burlington : <span class="label label-primary">60215</span>
			...
			<p>	<span itemprop="about">Average household size in Burlington : <span class="label label-primary">2.48</span>
			<p>	<span itemprop="about">Average family size in Burlington : <span class="label label-primary">3.03</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Burlington : <span class="label label-primary">153623</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Burlington : <span class="label label-primary">144524</span>					
			</p>
