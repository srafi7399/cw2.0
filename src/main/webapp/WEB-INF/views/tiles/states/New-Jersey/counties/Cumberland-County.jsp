...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Cumberland County : <span class="label label-primary">50047</span>
			...
			<p>	<span itemprop="about">Average household size in Cumberland County : <span class="label label-primary">2.89</span>
			<p>	<span itemprop="about">Average family size in Cumberland County : <span class="label label-primary">3.45</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Cumberland County : <span class="label label-primary">157658</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Cumberland County : <span class="label label-primary">146844</span>					
			</p>
