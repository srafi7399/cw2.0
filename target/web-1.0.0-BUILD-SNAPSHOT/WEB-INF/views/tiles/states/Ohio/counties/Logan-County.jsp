...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Logan County : <span class="label label-primary">18321</span>
			...
			<p>	<span itemprop="about">Average family size in Logan County : <span class="label label-primary">2.94</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Logan County : <span class="label label-primary">45519</span>					
			</p>
