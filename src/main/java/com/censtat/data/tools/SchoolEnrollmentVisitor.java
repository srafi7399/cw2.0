 ...
 *
 */
public class SchoolEnrollmentVisitor implements ModuleVisitorInterface {
	...
	private void createSchoolEnrollmentPage(DataEntity entity) {
		...
		if (entity.getDataEntityType().equals(DataEntityTypeInterface.CITY_TYPE)) {
			...
			CenModulePageCreator.getInstance().addModuleInfo(CenModulePageCreator.MODULE_SCHOOLENROLLMENT, toCreate, entity);
			return;
		}
	...
	private void buildandStoreGUICharts(DataEntity entity)
	{
		...
		CenPieChart pieChart0 = asBuilder.getAgeSexPieChart(entity,
				"name_school_enrollment_by_grade");		
		storeTheCharts(pieChart0,entity,"name_school_enrollment_by_grade");		
		}
