...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Danville : <span class="label label-primary">31666</span>
			...
			<p>	<span itemprop="about">Average household size in Danville : <span class="label label-primary">2.48</span>
			<p>	<span itemprop="about">Average family size in Danville : <span class="label label-primary">3.1</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Danville : <span class="label label-primary">80809</span>					
			</p>
