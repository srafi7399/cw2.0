...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Columbus : <span class="label label-primary">23224</span>
			...
			<p>	<span itemprop="about">Average household size in Columbus : <span class="label label-primary">2.51</span>
			<p>	<span itemprop="about">Average family size in Columbus : <span class="label label-primary">3.13</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Columbus : <span class="label label-primary">59749</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Columbus : <span class="label label-primary">N</span>					
			</p>
