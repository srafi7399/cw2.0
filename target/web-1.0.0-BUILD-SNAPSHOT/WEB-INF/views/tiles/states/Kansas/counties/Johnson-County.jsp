...
<div itemscope itemtype="http://schema.org/Dataset">				
		<div id = "sexsection" class="panel panel-default">
			...
			<div class = "col-lg-4">		
			<p>	Total population : <span class="label label-primary">559881</span>
			...
			<div class="col-lg-4">		
			<p>18 years and over: <span class="label label-primary">414999</span>
			...
			<div class="col-lg-4">			
			<p>65 years and over: <span class="label label-primary">65723</span>
			</p>
...
<div id = "hispanicorlatino" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population: <span class="label label-primary">559881</span></p>
			<div>			
...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Johnson County : <span class="label label-primary">218074</span>
			...
			<p>	<span itemprop="about">Average household size in Johnson County : <span class="label label-primary">2.54</span>
			<p>	<span itemprop="about">Average family size in Johnson County : <span class="label label-primary">3.1</span>	
			</p>
...
<div id = "relationship" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population in households : <span class="label label-primary">554692</span></p>
...
<div id = "maritalstatus" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population of Males 15 years and over : <span class="label label-primary">211763</span>
			<p> Population of Females 15 years and over: <span class="label label-primary">227204</span>		
...
<div id = "fertility" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	<span itemprop="about">Number of women 15 to 50 years old who had a birth in the past 12 months : <span class="label label-primary">8047</span></p>
...
<div id = "grandparents" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	<span itemprop="about">Number of grandparents living with own grandchildren under 18 years : <span class="label label-primary">6710</span></p>
			<p>	<span itemprop="about">Grandparents responsible for grandchildren : <span class="label label-primary">34.4 %</span></p>
			<p>	<span itemprop="about">Number of grandparents responsible for own grandchildren under 18 years : <span class="label label-primary">2306 </span></p>
	...
	<div id = "schoolenrollment" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 3 years and over enrolled in school : <span class="label label-primary">155480</span></p>
...
<div id = "educationalatt" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 25 years and over : <span class="label label-primary">373367</span></p>
			<p>	Percent high school graduate or higher : <span class="label label-primary">95.6 %</span></p>
			<p>	Percent bachelors degree or higher : <span class="label label-primary">51.8 %</span></p>
...
<div id = "veterans" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	<span itemprop="about">Civilian population 18 years and over : <span class="label label-primary">414613</span></p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Johnson County : <span class="label label-primary">559881</span>					
			</p>
...
<div id = "citizenship" class="panel panel-default">		
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Foreign born population : <span class="label label-primary">45850</span></p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Johnson County : <span class="label label-primary">521280</span>					
			</p>
