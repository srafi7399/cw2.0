...
<div class="row">
	  ...
	  <div class="row">         
          <ol class="breadcrumb">
            ...
            <li class="active">Meigs County</li>
          </ol>
        </section>
 </div>
...
<div itemscope itemtype="http://schema.org/Dataset">				
		<div id = "sexsection" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">The ratio of Male to Female population in Meigs County (2013 Census Estimates)</h3>
			</div>
			<div  class="panel-body">
			<div class = "col-lg-4">		
			<p>	Total population : <span class="label label-primary">23599</span>
			...
			<div class="col-lg-4">		
			<p>18 years and over: <span class="label label-primary">18387</span>
			...
			<div class="col-lg-4">			
			<p>65 years and over: <span class="label label-primary">3858</span>
			</p>
...
(adsbygoogle = window.adsbygoogle || []).push({});
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Age details for Meigs County (2013 Census Estimates) </h3>
			</div>	
...
<div id ="racesection" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Race Data for Meigs County (2013 Census Estimates)</h3>
			</div>
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population : <span class="label label-primary">23599</span>	
...
<div id = "hispanicorlatino" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Hispanic or Latino and Race - Meigs County (2013 Census Estimates)</h3>
			</div>
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population: <span class="label label-primary">23599</span></p>
			<div>			
...
<div id = "householdsbytype" class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Households by type in <span itemprop="spatial">Meigs County (2013 Census Estimates)</h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Meigs County : <span class="label label-primary">9481</span>
			...
			<p>	<span itemprop="about">Average household size in Meigs County : <span class="label label-primary">2.46</span>
			<p>	<span itemprop="about">Average family size in Meigs County : <span class="label label-primary">2.9</span>	
			</p>
...
<div id = "relationship" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Relationship in <span itemprop="spatial">Meigs County households (2013 Census Estimates)</h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population in households : <span class="label label-primary">23365</span></p>
...
<div id = "maritalstatus" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Marital Status in <span itemprop="spatial">Meigs County (2013 Census Estimates)</h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population of Males 15 years and over : <span class="label label-primary">9529</span>
...
<div id = "fertility" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Fertility Data for Women in <span itemprop="spatial">Meigs County (2013 Census Estimates)</h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "grandparents" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Grandparents responsible for own Grandchildren in <span itemprop="spatial">Meigs County (2013 Census Estimates) </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
	...
	<div id = "schoolenrollment" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">School Enrollment in <span itemprop="spatial">Meigs County (2013 Census Estimates) </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 3 years and over enrolled in school : <span class="label label-primary">5245</span></p>
...
<div id = "educationalatt" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Educational Attainment in <span itemprop="spatial">Meigs County (2013 Census Estimates)</h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 25 years and over : <span class="label label-primary">16538</span></p>
...
<div id = "veterans" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Veterans Status in <span itemprop="spatial">Meigs County (2013 Census Estimates)</h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	<span itemprop="about">Civilian population 18 years and over : <span class="label label-primary">18387</span></p>
...
<div id = "birthplace" class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Place of Birth data for <span itemprop="spatial">Meigs County (2013 Census Estimates)</h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Meigs County : <span class="label label-primary">23599</span>					
			</p>
...
<div id = "citizenship" class="panel panel-default">		
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">U.S Citizenship Status for foreign born population in <span itemprop="spatial">Meigs County (2013 Census Estimates)</h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Foreign born population : <span class="label label-primary">91</span></p>
...
<div id = "language" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Language spoken at home in <span itemprop="spatial">Meigs County (2013 Census Estimates) </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Meigs County : <span class="label label-primary">N</span>					
			</p>
...
<div id = "ancestry" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Ancestry Data for population in <span itemprop="spatial">Meigs County (2013 Census Estimates) </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
...
<div id = "computers" class="panel panel-default">
			...
			<div class="panel-heading">
				<h3 class="panel-title"><span itemprop="about">Computers and Internet use in <span itemprop="spatial">Meigs County (2013 Census Estimates) </h3>
			</div>			
			<div  class="panel-body">
			<div class = "col-xs-12">		
