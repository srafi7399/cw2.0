...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Wilmington : <span class="label label-primary">15953</span>
			...
			<p>	<span itemprop="about">Average household size in Wilmington : <span class="label label-primary">2.55</span>
			<p>	<span itemprop="about">Average family size in Wilmington : <span class="label label-primary">3.03</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Wilmington : <span class="label label-primary">41921</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Wilmington : <span class="label label-primary">N</span>					
			</p>
