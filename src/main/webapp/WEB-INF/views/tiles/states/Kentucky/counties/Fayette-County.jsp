...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Fayette County : <span class="label label-primary">123413</span>
			...
			<p>	<span itemprop="about">Average household size in Fayette County : <span class="label label-primary">2.37</span>
			<p>	<span itemprop="about">Average family size in Fayette County : <span class="label label-primary">3</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Fayette County : <span class="label label-primary">304998</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Fayette County : <span class="label label-primary">285716</span>					
			</p>
