...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Midland : <span class="label label-primary">33543</span>
			...
			<p>	<span itemprop="about">Average household size in Midland : <span class="label label-primary">2.46</span>
			<p>	<span itemprop="about">Average family size in Midland : <span class="label label-primary">2.98</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Midland : <span class="label label-primary">83971</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Midland : <span class="label label-primary">79484</span>					
			</p>
