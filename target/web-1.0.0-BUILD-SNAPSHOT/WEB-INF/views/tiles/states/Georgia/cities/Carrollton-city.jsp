...
<div itemscope itemtype="http://schema.org/Dataset">				
		<div id = "sexsection" class="panel panel-default">
			...
			<div class = "col-lg-4">		
			<p>	Total population : <span class="label label-primary">24885</span>
			...
			<div class="col-lg-4">		
			<p>18 years and over: <span class="label label-primary">19481</span>
			...
			<div class="col-lg-4">			
			<p>65 years and over: <span class="label label-primary">2264</span>
			</p>
...
<div id = "hispanicorlatino" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population: <span class="label label-primary">24885</span></p>
			<div>			
...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Carrollton city : <span class="label label-primary">8588</span>
			...
			<p>	<span itemprop="about">Average household size in Carrollton city : <span class="label label-primary">2.47</span>
			<p>	<span itemprop="about">Average family size in Carrollton city : <span class="label label-primary">3.31</span>	
			</p>
...
<div id = "relationship" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population in households : <span class="label label-primary">21196</span></p>
...
<div id = "maritalstatus" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population of Males 15 years and over : <span class="label label-primary">9438</span>
			<p> Population of Females 15 years and over: <span class="label label-primary">10891</span>		
...
<div id = "grandparents" class="panel panel-default">
	...
	<div id = "schoolenrollment" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 3 years and over enrolled in school : <span class="label label-primary">11161</span></p>
...
<div id = "educationalatt" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 25 years and over : <span class="label label-primary">12775</span></p>
...
<div id = "veterans" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	<span itemprop="about">Civilian population 18 years and over : <span class="label label-primary">19412</span></p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Carrollton city : <span class="label label-primary">24885</span>					
			</p>
...
<div id = "citizenship" class="panel panel-default">		
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Foreign born population : <span class="label label-primary">2930</span></p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Carrollton city : <span class="label label-primary">N</span>					
			</p>
