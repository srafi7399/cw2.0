...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Columbus : <span class="label label-primary">12665</span>
			...
			<p>	<span itemprop="about">Average household size in Columbus : <span class="label label-primary">2.53</span>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Columbus : <span class="label label-primary">32489</span>					
			</p>
