...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Washington : <span class="label label-primary">11270</span>
			...
			<p>	<span itemprop="about">Average household size in Washington : <span class="label label-primary">2.8</span>
			<p>	<span itemprop="about">Average family size in Washington : <span class="label label-primary">3.38</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Washington : <span class="label label-primary">32179</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Washington : <span class="label label-primary">29485</span>					
			</p>
