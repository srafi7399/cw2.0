...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Madison : <span class="label label-primary">12604</span>
			...
			<p>	<span itemprop="about">Average household size in Madison : <span class="label label-primary">2.39</span>
			<p>	<span itemprop="about">Average family size in Madison : <span class="label label-primary">2.86</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Madison : <span class="label label-primary">32420</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Madison : <span class="label label-primary">N</span>					
			</p>
