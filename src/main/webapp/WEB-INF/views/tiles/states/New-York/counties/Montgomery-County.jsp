...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Montgomery County : <span class="label label-primary">19390</span>
			...
			<p>	<span itemprop="about">Average household size in Montgomery County : <span class="label label-primary">2.52</span>
			<p>	<span itemprop="about">Average family size in Montgomery County : <span class="label label-primary">3.1</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Montgomery County : <span class="label label-primary">49932</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Montgomery County : <span class="label label-primary">46943</span>					
			</p>
