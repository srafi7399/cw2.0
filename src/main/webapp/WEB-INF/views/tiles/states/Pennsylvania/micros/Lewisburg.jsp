...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Lewisburg : <span class="label label-primary">14742</span>
			...
			<p>	<span itemprop="about">Average household size in Lewisburg : <span class="label label-primary">2.41</span>
			<p>	<span itemprop="about">Average family size in Lewisburg : <span class="label label-primary">2.95</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Lewisburg : <span class="label label-primary">44967</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Lewisburg : <span class="label label-primary">42884</span>					
			</p>
