...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Lincoln : <span class="label label-primary">10228</span>
			...
			<p>	<span itemprop="about">Average household size in Lincoln : <span class="label label-primary">2.17</span>
			<p>	<span itemprop="about">Average family size in Lincoln : <span class="label label-primary">2.62</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Lincoln : <span class="label label-primary">30085</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Lincoln : <span class="label label-primary">N</span>					
			</p>
