...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Somerset : <span class="label label-primary">25993</span>
			...
			<p>	<span itemprop="about">Average household size in Somerset : <span class="label label-primary">2.41</span>
			<p>	<span itemprop="about">Average family size in Somerset : <span class="label label-primary">2.91</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Somerset : <span class="label label-primary">63648</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Somerset : <span class="label label-primary">N</span>					
			</p>
