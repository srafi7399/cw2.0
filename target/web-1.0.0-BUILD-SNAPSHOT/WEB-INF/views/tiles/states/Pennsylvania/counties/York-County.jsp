...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in York County : <span class="label label-primary">166924</span>
			...
			<p>	<span itemprop="about">Average household size in York County : <span class="label label-primary">2.57</span>
			<p>	<span itemprop="about">Average family size in York County : <span class="label label-primary">3.06</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in York County : <span class="label label-primary">437720</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in York County : <span class="label label-primary">411933</span>					
			</p>
