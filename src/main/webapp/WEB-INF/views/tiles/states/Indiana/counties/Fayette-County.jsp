...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Fayette County : <span class="label label-primary">9425</span>
			...
			<p>	<span itemprop="about">Average household size in Fayette County : <span class="label label-primary">2.5</span>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Fayette County : <span class="label label-primary">23998</span>					
			</p>
