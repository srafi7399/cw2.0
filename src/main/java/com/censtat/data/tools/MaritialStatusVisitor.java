 ...
 *
 */
public class MaritialStatusVisitor implements ModuleVisitorInterface {
	...
	private void createMaritialStatusPage(DataEntity entity) {
		...
		if (entity.getDataEntityType().equals(DataEntityTypeInterface.CITY_TYPE)) {
			...
			CenModulePageCreator.getInstance().addModuleInfo(CenModulePageCreator.MODULE_MARITIAL_STATUS, toCreate, entity);
			return;
		}
	...
	private void buildandStoreGUICharts(DataEntity entity)
	{
		...
		CenPieChart pieChart0 = asBuilder.getAgeSexPieChart(entity,
				"name_maritial_status_male");
		CenPieChart pieChart1 = asBuilder.getAgeSexPieChart(entity,
				"name_maritial_status_female");
		storeTheCharts(pieChart0,entity,"name_maritial_status_male");
		storeTheCharts(pieChart1,entity,"name_maritial_status_female");
