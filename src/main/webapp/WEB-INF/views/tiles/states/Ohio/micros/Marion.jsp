...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Marion : <span class="label label-primary">24399</span>
			...
			<p>	<span itemprop="about">Average household size in Marion : <span class="label label-primary">2.43</span>
			<p>	<span itemprop="about">Average family size in Marion : <span class="label label-primary">2.88</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Marion : <span class="label label-primary">66221</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Marion : <span class="label label-primary">N</span>					
			</p>
