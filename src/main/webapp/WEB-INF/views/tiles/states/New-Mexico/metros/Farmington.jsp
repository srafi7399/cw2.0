...
<div class="row">
	  ...
	  <div class="row">         
          <ol class="breadcrumb">
		            ...
		            <li><a href="/states/New-Mexico/metros-New-Mexico"><i class="fa fa-dashboard"></i> Metros</a></li>
...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Farmington : <span class="label label-primary">39683</span>
			...
			<p>	<span itemprop="about">Average household size in Farmington : <span class="label label-primary">3.17</span>
			<p>	<span itemprop="about">Average family size in Farmington : <span class="label label-primary">3.79</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Farmington : <span class="label label-primary">127620</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Farmington : <span class="label label-primary">117745</span>					
			</p>
