...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Marshall : <span class="label label-primary">8609</span>
			...
			<p>	<span itemprop="about">Average household size in Marshall : <span class="label label-primary">2.55</span>
			<p>	<span itemprop="about">Average family size in Marshall : <span class="label label-primary">3.08</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Marshall : <span class="label label-primary">23333</span>					
			</p>
