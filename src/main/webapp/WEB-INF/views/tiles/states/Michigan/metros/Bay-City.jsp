...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Bay City : <span class="label label-primary">43937</span>
			...
			<p>	<span itemprop="about">Average household size in Bay City : <span class="label label-primary">2.4</span>
			<p>	<span itemprop="about">Average family size in Bay City : <span class="label label-primary">2.97</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Bay City : <span class="label label-primary">106984</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Bay City : <span class="label label-primary">101165</span>					
			</p>
