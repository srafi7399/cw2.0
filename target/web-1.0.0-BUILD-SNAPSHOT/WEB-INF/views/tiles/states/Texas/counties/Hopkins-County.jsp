...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Hopkins County : <span class="label label-primary">13360</span>
			...
			<p>	<span itemprop="about">Average household size in Hopkins County : <span class="label label-primary">2.62</span>
			<p>	<span itemprop="about">Average family size in Hopkins County : <span class="label label-primary">3.03</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Hopkins County : <span class="label label-primary">35445</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Hopkins County : <span class="label label-primary">33006</span>					
			</p>
