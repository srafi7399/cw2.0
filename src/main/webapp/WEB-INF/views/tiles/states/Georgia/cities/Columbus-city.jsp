...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Columbus city : <span class="label label-primary">71351</span>
			...
			<p>	<span itemprop="about">Average household size in Columbus city : <span class="label label-primary">2.62</span>
			<p>	<span itemprop="about">Average family size in Columbus city : <span class="label label-primary">3.31</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Columbus city : <span class="label label-primary">198498</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Columbus city : <span class="label label-primary">183683</span>					
			</p>
