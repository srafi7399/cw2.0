...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Mountain Home : <span class="label label-primary">9737</span>
			...
			<p>	<span itemprop="about">Average household size in Mountain Home : <span class="label label-primary">2.61</span>
			<p>	<span itemprop="about">Average family size in Mountain Home : <span class="label label-primary">3.15</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Mountain Home : <span class="label label-primary">26257</span>					
			</p>
