...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Lebanon : <span class="label label-primary">13621</span>
			...
			<p>	<span itemprop="about">Average household size in Lebanon : <span class="label label-primary">2.58</span>
			<p>	<span itemprop="about">Average family size in Lebanon : <span class="label label-primary">2.94</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Lebanon : <span class="label label-primary">35555</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Lebanon : <span class="label label-primary">N</span>					
			</p>
