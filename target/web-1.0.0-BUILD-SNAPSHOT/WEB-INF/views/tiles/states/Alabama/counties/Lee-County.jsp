...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Lee County : <span class="label label-primary">56312</span>
			...
			<p>	<span itemprop="about">Average household size in Lee County : <span class="label label-primary">2.53</span>
			<p>	<span itemprop="about">Average family size in Lee County : <span class="label label-primary">3.08</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Lee County : <span class="label label-primary">147537</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Lee County : <span class="label label-primary">138875</span>					
			</p>
