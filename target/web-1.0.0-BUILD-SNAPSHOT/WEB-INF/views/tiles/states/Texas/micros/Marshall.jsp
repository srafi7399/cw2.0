...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Marshall : <span class="label label-primary">23810</span>
			...
			<p>	<span itemprop="about">Average household size in Marshall : <span class="label label-primary">2.76</span>
			<p>	<span itemprop="about">Average family size in Marshall : <span class="label label-primary">3.31</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Marshall : <span class="label label-primary">67137</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Marshall : <span class="label label-primary">N</span>					
			</p>
