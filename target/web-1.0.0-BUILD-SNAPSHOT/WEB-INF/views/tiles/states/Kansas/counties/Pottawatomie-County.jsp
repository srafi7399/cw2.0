...
<div itemscope itemtype="http://schema.org/Dataset">				
		<div id = "sexsection" class="panel panel-default">
			...
			<div class = "col-lg-4">		
			<p>	Total population : <span class="label label-primary">22368</span>
			...
			<div class="col-lg-4">		
			<p>18 years and over: <span class="label label-primary">15749</span>
			...
			<div class="col-lg-4">			
			<p>65 years and over: <span class="label label-primary">2855</span>
			</p>
...
<div id = "hispanicorlatino" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population: <span class="label label-primary">22368</span></p>
			<div>			
...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Pottawatomie County : <span class="label label-primary">8146</span>
			...
			<p>	<span itemprop="about">Average household size in Pottawatomie County : <span class="label label-primary">2.71</span>
			<p>	<span itemprop="about">Average family size in Pottawatomie County : <span class="label label-primary">3.32</span>	
			</p>
...
<div id = "relationship" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population in households : <span class="label label-primary">22049</span></p>
...
<div id = "maritalstatus" class="panel panel-default">
			...
			<p> Population of Females 15 years and over: <span class="label label-primary">8632</span>		
...
<div id = "grandparents" class="panel panel-default">
	...
	<div id = "schoolenrollment" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 3 years and over enrolled in school : <span class="label label-primary">6033</span></p>
...
<div id = "educationalatt" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 25 years and over : <span class="label label-primary">13947</span></p>
			<p>	Percent high school graduate or higher : <span class="label label-primary">96.6 %</span></p>
...
<div id = "veterans" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	<span itemprop="about">Civilian population 18 years and over : <span class="label label-primary">15620</span></p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Pottawatomie County : <span class="label label-primary">22368</span>					
			</p>
...
<div id = "citizenship" class="panel panel-default">		
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Foreign born population : <span class="label label-primary">385</span></p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Pottawatomie County : <span class="label label-primary">N</span>					
			</p>
