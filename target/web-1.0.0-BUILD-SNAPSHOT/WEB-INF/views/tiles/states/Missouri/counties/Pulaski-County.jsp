...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Pulaski County : <span class="label label-primary">15491</span>
			...
			<p>	<span itemprop="about">Average household size in Pulaski County : <span class="label label-primary">2.83</span>
			<p>	<span itemprop="about">Average family size in Pulaski County : <span class="label label-primary">3.48</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Pulaski County : <span class="label label-primary">53489</span>					
			</p>
