...
public class BirthRegionVisitor implements ModuleVisitorInterface {
	...
	public FileWriter visit(DataEntity entity, FileWriter writer) {
		...
		Mustache mustache = mf.compile("templates/foreignborn.tmpl");
	...
	private void buildandStoreGUICharts(DataEntity entity) {
		...
		CenPieChart pieChart0 = asBuilder.getAgeSexPieChart(entity,
				"name_foreign_born_population_regions");		
		storeTheCharts(pieChart0, entity,"name_foreign_born_population_regions");
	}
