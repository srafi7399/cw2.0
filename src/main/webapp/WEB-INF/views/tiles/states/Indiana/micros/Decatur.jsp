...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Decatur : <span class="label label-primary">11937</span>
			...
			<p>	<span itemprop="about">Average household size in Decatur : <span class="label label-primary">2.84</span>
			<p>	<span itemprop="about">Average family size in Decatur : <span class="label label-primary">3.51</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Decatur : <span class="label label-primary">34447</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Decatur : <span class="label label-primary">N</span>					
			</p>
