...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Centralia : <span class="label label-primary">15813</span>
			...
			<p>	<span itemprop="about">Average household size in Centralia : <span class="label label-primary">2.41</span>
			<p>	<span itemprop="about">Average family size in Centralia : <span class="label label-primary">2.92</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Centralia : <span class="label label-primary">38820</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Centralia : <span class="label label-primary">N</span>					
			</p>
