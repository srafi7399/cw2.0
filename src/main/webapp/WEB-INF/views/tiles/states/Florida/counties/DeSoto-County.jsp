...
<div itemscope itemtype="http://schema.org/Dataset">				
		<div id = "sexsection" class="panel panel-default">
			...
			<div class = "col-lg-4">		
			<p>	Total population : <span class="label label-primary">34583</span>
			...
			<div class="col-lg-4">		
			<p>18 years and over: <span class="label label-primary">27083</span>
...
<div id = "hispanicorlatino" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population: <span class="label label-primary">34583</span></p>
			<div>			
			<p>Hispanic or Latino (of any race): <span class="label label-primary">30 %</span></p>
			<div class="table-responsive">
						<table
							class="table table-condensed table-striped table-bordered table-hover no-margin">
							<thead>
			...
			<div>			
			<p>Not Hispanic or Latino: <span class="label label-primary">70 %</span></p>
			<div class="table-responsive">
						<table
							class="table table-condensed table-striped table-bordered table-hover no-margin">
							<thead>
...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in DeSoto County : <span class="label label-primary">10966</span>
			...
			<p>	<span itemprop="about">Average family size in DeSoto County : <span class="label label-primary">3.4</span>	
			</p>
...
<div id = "relationship" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population in households : <span class="label label-primary">30943</span></p>
...
<div id = "maritalstatus" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population of Males 15 years and over : <span class="label label-primary">16240</span>
			<p> Population of Females 15 years and over: <span class="label label-primary">12054</span>		
...
<div id = "fertility" class="panel panel-default">
			...
			<p>	<span itemprop="about">Unmarried women (widowed, divorced, and never married) : <span class="label label-primary">77.1 %</span></p>
...
<div id = "grandparents" class="panel panel-default">
	...
	<div id = "schoolenrollment" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 3 years and over enrolled in school : <span class="label label-primary">6966</span></p>
...
<div id = "veterans" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	<span itemprop="about">Civilian population 18 years and over : <span class="label label-primary">27072</span></p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in DeSoto County : <span class="label label-primary">34583</span>					
			</p>
...
<div id = "citizenship" class="panel panel-default">		
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Foreign born population : <span class="label label-primary">5784</span></p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in DeSoto County : <span class="label label-primary">N</span>					
			</p>
