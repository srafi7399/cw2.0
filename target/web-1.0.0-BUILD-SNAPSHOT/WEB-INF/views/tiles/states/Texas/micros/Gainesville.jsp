...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Gainesville : <span class="label label-primary">14184</span>
			...
			<p>	<span itemprop="about">Average household size in Gainesville : <span class="label label-primary">2.67</span>
			<p>	<span itemprop="about">Average family size in Gainesville : <span class="label label-primary">3.15</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Gainesville : <span class="label label-primary">38519</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Gainesville : <span class="label label-primary">N</span>					
			</p>
