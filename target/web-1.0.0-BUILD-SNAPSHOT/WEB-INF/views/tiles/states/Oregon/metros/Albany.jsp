...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Albany : <span class="label label-primary">44458</span>
			...
			<p>	<span itemprop="about">Average household size in Albany : <span class="label label-primary">2.64</span>
			<p>	<span itemprop="about">Average family size in Albany : <span class="label label-primary">3.09</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Albany : <span class="label label-primary">118450</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Albany : <span class="label label-primary">110804</span>					
			</p>
