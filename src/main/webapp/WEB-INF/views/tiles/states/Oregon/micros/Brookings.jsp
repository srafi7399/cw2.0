...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Brookings : <span class="label label-primary">10413</span>
			...
			<p>	<span itemprop="about">Average household size in Brookings : <span class="label label-primary">2.12</span>
			<p>	<span itemprop="about">Average family size in Brookings : <span class="label label-primary">2.65</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Brookings : <span class="label label-primary">22366</span>					
			</p>
