...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Greenville : <span class="label label-primary">20834</span>
			...
			<p>	<span itemprop="about">Average household size in Greenville : <span class="label label-primary">2.49</span>
			<p>	<span itemprop="about">Average family size in Greenville : <span class="label label-primary">3.12</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Greenville : <span class="label label-primary">52514</span>					
			</p>
