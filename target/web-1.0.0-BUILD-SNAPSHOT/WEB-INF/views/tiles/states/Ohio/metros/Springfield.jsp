...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Springfield : <span class="label label-primary">54405</span>
			...
			<p>	<span itemprop="about">Average household size in Springfield : <span class="label label-primary">2.46</span>
			<p>	<span itemprop="about">Average family size in Springfield : <span class="label label-primary">3.03</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Springfield : <span class="label label-primary">137031</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Springfield : <span class="label label-primary">128779</span>					
			</p>
