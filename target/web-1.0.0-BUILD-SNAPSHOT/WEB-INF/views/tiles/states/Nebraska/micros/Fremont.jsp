...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Fremont : <span class="label label-primary">15131</span>
			...
			<p>	<span itemprop="about">Average household size in Fremont : <span class="label label-primary">2.36</span>
			<p>	<span itemprop="about">Average family size in Fremont : <span class="label label-primary">2.82</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Fremont : <span class="label label-primary">36690</span>					
			</p>
