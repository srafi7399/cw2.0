...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Fairfield County : <span class="label label-primary">331134</span>
			...
			<p>	<span itemprop="about">Average household size in Fairfield County : <span class="label label-primary">2.76</span>
			<p>	<span itemprop="about">Average family size in Fairfield County : <span class="label label-primary">3.35</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Fairfield County : <span class="label label-primary">933794</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Fairfield County : <span class="label label-primary">878494</span>					
			</p>
