...
<div itemscope itemtype="http://schema.org/Dataset">				
		<div id = "sexsection" class="panel panel-default">
			...
			<div class = "col-lg-4">		
			<p>	Total population : <span class="label label-primary">146690</span>
			...
			<div class="col-lg-4">		
			<p>18 years and over: <span class="label label-primary">120999</span>
			...
			<div class="col-lg-4">			
			<p>65 years and over: <span class="label label-primary">13957</span>
			</p>
...
<div id = "hispanicorlatino" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population: <span class="label label-primary">146690</span></p>
			<div>			
...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Alexandria city : <span class="label label-primary">65294</span>
			<p>	<span itemprop="about">Households with one or more people under 18 years  : <span class="label label-primary">22.2%</span>
			<p>	<span itemprop="about">Households with one or more people 65 years and over  : <span class="label label-primary">15.7%</span>
			<p>	<span itemprop="about">Average household size in Alexandria city : <span class="label label-primary">2.23</span>
			<p>	<span itemprop="about">Average family size in Alexandria city : <span class="label label-primary">3.11</span>	
			</p>
...
<div id = "relationship" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population in households : <span class="label label-primary">145425</span></p>
...
<div id = "maritalstatus" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population of Males 15 years and over : <span class="label label-primary">59747</span>
			<p> Population of Females 15 years and over: <span class="label label-primary">64288</span>		
...
<div id = "grandparents" class="panel panel-default">
			...
			<p>	<span itemprop="about">Percentage of female grandparents responsible for own grandchildren under 18 years : <span class="label label-primary">86.2 %</span></p>
	...
	<div id = "schoolenrollment" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 3 years and over enrolled in school : <span class="label label-primary">30273</span></p>
...
<div id = "educationalatt" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 25 years and over : <span class="label label-primary">111619</span></p>
			<p>	Percent high school graduate or higher : <span class="label label-primary">90.7 %</span></p>
			<p>	Percent bachelors degree or higher : <span class="label label-primary">61.7 %</span></p>
...
<div id = "veterans" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	<span itemprop="about">Civilian population 18 years and over : <span class="label label-primary">118888</span></p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Alexandria city : <span class="label label-primary">146690</span>					
			</p>
...
<div id = "citizenship" class="panel panel-default">		
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Foreign born population : <span class="label label-primary">40509</span></p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Alexandria city : <span class="label label-primary">135833</span>					
			</p>
