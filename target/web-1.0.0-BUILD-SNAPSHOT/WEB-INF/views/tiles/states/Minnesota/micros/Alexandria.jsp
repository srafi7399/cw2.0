...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Alexandria : <span class="label label-primary">15228</span>
			...
			<p>	<span itemprop="about">Average household size in Alexandria : <span class="label label-primary">2.35</span>
			<p>	<span itemprop="about">Average family size in Alexandria : <span class="label label-primary">2.79</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Alexandria : <span class="label label-primary">36413</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Alexandria : <span class="label label-primary">N</span>					
			</p>
