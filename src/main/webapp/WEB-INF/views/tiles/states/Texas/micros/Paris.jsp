...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Paris : <span class="label label-primary">19007</span>
			...
			<p>	<span itemprop="about">Average household size in Paris : <span class="label label-primary">2.57</span>
			<p>	<span itemprop="about">Average family size in Paris : <span class="label label-primary">3.13</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Paris : <span class="label label-primary">49769</span>					
			</p>
