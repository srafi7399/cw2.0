...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Jacksonville : <span class="label label-primary">17571</span>
			...
			<p>	<span itemprop="about">Average household size in Jacksonville : <span class="label label-primary">2.75</span>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Jacksonville : <span class="label label-primary">51000</span>					
			</p>
