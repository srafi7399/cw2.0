...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Richmond : <span class="label label-primary">27966</span>
			...
			<p>	<span itemprop="about">Average household size in Richmond : <span class="label label-primary">2.35</span>
			<p>	<span itemprop="about">Average family size in Richmond : <span class="label label-primary">2.86</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Richmond : <span class="label label-primary">68308</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Richmond : <span class="label label-primary">64164</span>					
			</p>
