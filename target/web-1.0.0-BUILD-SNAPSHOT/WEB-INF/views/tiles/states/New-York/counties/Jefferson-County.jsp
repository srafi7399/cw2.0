...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Jefferson County : <span class="label label-primary">44651</span>
			...
			<p>	<span itemprop="about">Average household size in Jefferson County : <span class="label label-primary">2.54</span>
			<p>	<span itemprop="about">Average family size in Jefferson County : <span class="label label-primary">3.05</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Jefferson County : <span class="label label-primary">119580</span>					
			</p>
...
<div id = "language" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Population 5 years and over in Jefferson County : <span class="label label-primary">109390</span>					
			</p>
