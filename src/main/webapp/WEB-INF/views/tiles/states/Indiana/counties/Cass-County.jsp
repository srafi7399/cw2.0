...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Cass County : <span class="label label-primary">14802</span>
			...
			<p>	<span itemprop="about">Average household size in Cass County : <span class="label label-primary">2.55</span>
			<p>	<span itemprop="about">Average family size in Cass County : <span class="label label-primary">3.14</span>	
			</p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Cass County : <span class="label label-primary">38683</span>					
			</p>
