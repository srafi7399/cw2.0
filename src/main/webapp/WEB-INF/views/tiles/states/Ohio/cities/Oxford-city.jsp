...
<div itemscope itemtype="http://schema.org/Dataset">				
		<div id = "sexsection" class="panel panel-default">
			...
			<div class = "col-lg-4">		
			<p>	Total population : <span class="label label-primary">21483</span>
			...
			<div class="col-lg-4">			
			<p>65 years and over: <span class="label label-primary">1404</span>
			</p>
...
(adsbygoogle = window.adsbygoogle || []).push({});
		...
		<div class="panel panel-default">
			...
			<div class = "col-lg-4">		
			<p>Median age (years): <span class="label label-primary">21.2 years</span>
			<p>18 years and over: <span class="label label-primary">95.8%</span>
			<p>21 years and over: <span class="label label-primary">53.7%</span>
...
<div id = "hispanicorlatino" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Total population: <span class="label label-primary">21483</span></p>
			<div>			
...
<div id = "householdsbytype" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	<span itemprop="about">Total Households in Oxford city : <span class="label label-primary">5675</span>
			...
			<p>	<span itemprop="about">Average household size in Oxford city : <span class="label label-primary">2.42</span>
			<p>	<span itemprop="about">Average family size in Oxford city : <span class="label label-primary">2.51</span>	
			</p>
...
<div id = "relationship" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population in households : <span class="label label-primary">13720</span></p>
...
<div id = "maritalstatus" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population of Males 15 years and over : <span class="label label-primary">10771</span>
			<p> Population of Females 15 years and over: <span class="label label-primary">9982</span>		
...
<div id = "grandparents" class="panel panel-default">
	...
	<div id = "schoolenrollment" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 3 years and over enrolled in school : <span class="label label-primary">15738</span></p>
...
<div id = "educationalatt" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	Population 25 years and over : <span class="label label-primary">5593</span></p>
			<p>	Percent high school graduate or higher : <span class="label label-primary">94.1 %</span></p>
			<p>	Percent bachelors degree or higher : <span class="label label-primary">63.3 %</span></p>
...
<div id = "veterans" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-12">		
			<p>	<span itemprop="about">Civilian population 18 years and over : <span class="label label-primary">20584</span></p>
...
<div id = "birthplace" class="panel panel-default">
			...
			<div  class="panel-body">
			<div class = "col-xs-6">		
			<p>	Total Population in Oxford city : <span class="label label-primary">21483</span>					
			</p>
